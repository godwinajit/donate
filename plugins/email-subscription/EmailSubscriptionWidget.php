...
class EmailSubscriptionWidget extends WP_Widget {
    ...
    public function widget($args, $instance) {
        ...
        <div id='emailSub-widget'>
            <div id="emailSub-output" style="text-align:center;padding-bottom:5px"></div>
            <form id="emailSub-form" action="<?php echo site_url('wp-admin/admin-ajax.php')?>" style="display:block !important;">
                ...
                <div class="form-heading"><span>Subscribe</span></div>
                <div class="form-group">
                <input type="text" name="email" id="emailSub-email" class="form-control" placeholder="YOUR E-MAIL" />
              	</div>
                <input type="submit" class="btn btn-default center-block" value="<?php echo $instance['submit_button'];?>" />
                <?php if ($promotion): ?>
