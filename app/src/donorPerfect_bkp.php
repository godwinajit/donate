...
class DonorPerfect {
	...
	public function __construct($dpAPIKey, $log, $emailList, $donorEmailList) {
  ...
  $message .= '</div>';
	...
	$donateMail = SimpleMail::make()
		   // ->setTo($this->emailList)
		    ->setFrom('info@globallymealliance.org', 'Global Lyme Alliance')
		    ->setSubject('Donation Submission Failed')
		    ->setMessage($message)
		    ->setReplyTo('info@globallymealliance.org', 'Global Lyme Alliance')
		    ->setHtml()
		    ->setWrap(100);
