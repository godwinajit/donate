				...
				<div class="col-xs-11 col-md-10">
					<div class="row">
						<div class="col-xs-12 col-md-6 col-md-short">
							...
							<div class="row">
								...
								<div class="col-xs-12 col-sm-6" id="zippostal1">
									<label>* Zip</label> <input maxlength="6" type="text" name="zip"
										required>
								</div>
							</div>
							<!-- <div class="row">
						...
						<div class="col-xs-12 col-md-6 col-md-short">
							...
							<div class="row">
								<div class="col-xs-12">
									<label>If yes, what language? (Click to select multiple languages)</label>
										<select name="language_1[]" multiple placeholder="Please Select Language/s" data-jcf='{"wrapNative": false, "wrapNativeOnMobile": false, "useCustomScroll": false, "multipleCompactStyle": true}'>
