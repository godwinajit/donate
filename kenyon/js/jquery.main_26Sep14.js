	...
	jQuery('.build-section').each(function(){
		...
		var initSteps = function(getIndex, sameIndex){
			...
			if (getIndex) {
				...
				if (activeIndex == stepsContent.length-1) {
					jQuery.ajax({
						url: target,
						type: 'post',
			...
			function linksHandler(e) {
				...
				var key = currentLink.parents('.build-block').attr('id');
		...
		var parseData = function(newHTML){
			// remove old blocks
			...
			jQuery(newHTML.steps).each(function () {
				...
				function createTemplate1 () {
					...
					options.each(function () {
						...
						optionsStr += '<li><a href="#" '+condition+' data-rel="' + option.value + '">'+ '<img src="' +
							 option.image +
							'" width="300" height="300" alt="image description">' + '<div class="text-block">'+
											'<h3>' + option.title + '</h3>'+
											descript +
										'</div>'+
									'</a></li>';
					});
					var stepBlock = '<div class="build-block'+invis+'" data-hidden="'+step.hidden+'" id="' + step.id + '">' +
								'<div class="heading">' +
									'<h2>' + step.title + '</h2>' +
								'</div>' +
				...
				function createTemplate2 () {
					...
					options.each(function () {
						...
						optionsStr += '<li>'+ '<img src="' +
							 option.image +
							'" width="300" height="300" alt="image description">' + '<div class="btn-holder">'+
					...
					options.each(function (i) {
						...
						childrens.each(function (i) {
							...
							childrenStr += '<li><a href="#" '+condition+' data-rel="'+ children.value +'">'+
								'<img src="' + children.image + '" width="300" height="300" alt="image description">'+
									txtBlock+
							'</a></li>';
						});
