...
<li><a class="view-360 iframe-lightbox iframe" data-width="553" data-height="330" href="<?php echo add_query_arg('view360', $isImages360View, get_permalink(get_the_ID())); ?>"><?php _e('360 view', 'kenyon'); ?></a></li>