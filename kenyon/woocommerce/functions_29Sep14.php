...
function theme_load_scripts() {
	...
	wp_register_script('wc-country-select', get_template_directory_uri() . '/woocommerce/js/country-select.js', array( 'jquery' ), WC_VERSION, true );
	wp_localize_script('wc-country-select');
...
/*** Include my widgets ***/
function addmy_widgets() {
	echo '<script type="text/javascript">alert("test");</script>';
	register_widget( 'WC_Widget_MyProduct_Categories' );
}