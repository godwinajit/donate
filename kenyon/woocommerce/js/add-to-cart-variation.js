		...
		$form = this
			...
			.on( 'check_variations', function( event, exclude, focus ) {
				...
				if ( all_set ) {
					...
					if ( ! exclude ) {
						$variation_form.find( '.single_variation_wrap' ).addClass('disabled').show();
						
						$variation_form.find('.default-price').show();
						
						
						if ($variation_form.find('.single_variation .price').length) {
							$variation_form.find('.single_variation .price').hide();
						}
					}
			...
			.on( 'found_variation', function( event, variation ) {
				...
				if ($single_variation_wrap.find('.single_variation .price').length) {
					$single_variation_wrap.find('.default-price').hide();
				}
