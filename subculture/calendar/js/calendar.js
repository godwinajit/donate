...
(function() {
	...
	if(!Date.prototype.getFullTime) {
		Date.prototype.getFullTime = function(type, divider) {
			var hour = this.getHours();
			var minutes = this.getMinutes();
			var divider = divider || ':';
			if(type === '24'){
				return hour + divider + minutes.toString().formatNum(2);
			}
			else {
				...
				return hour + divider + minutes.toString().formatNum(2) + ampm;
			};
		};
	};
	...
	(function($) {
		...
		Calendar.prototype._update = function() {
			...
			jQuery('.cal-month-box').sameHeight({
				elements: '.cal-month-day',
				flexible: true,
				multiLine: true
			});
		};
