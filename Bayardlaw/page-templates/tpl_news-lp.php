			...
			<div class="content-section">
				<div class="news-gallery">
					<div class="mask">
						...
						<?php $latest_page = (get_query_var('paged')) ? get_query_var('paged') : 1;
						...
						<?php $i=1;  
						$published_posts = $query2->post_count;
							...
							<?php endif;?>
									<div class="col-sm-6 col-xs-12">
										<section class="news-box news-box-border">
											<div class="frame">
											<?php  $post_categories = wp_get_post_categories( $query2->post->ID );
												...
												<header>
													...
													<?php if($cat->slug=='publications'):?>
													<?php 
													$post_objects = get_field('attorneys_tag');													
													if( $post_objects ): ?>
													    <ul>
													    <?php  foreach( $post_objects as $p): // variable must be called $post (IMPORTANT) ?>
													        <a href="<?php echo get_permalink($p); ?>" class="author">- By <?php echo get_the_title($p); ?> </a>
													    <?php endforeach; ?>
													    </ul>
												...
												echo wp_trim_words( get_the_content($query2->post->ID), 25, '...' );?></p>
												<!-- <ul class="list-inline">
											...
											<footer>
											<?php 
											$readMore_Name = $cat->name;
											if($cat->name == 'Legal Updates')$readMore_Name = 'Legal Update';
											else if($cat->name == 'Publications')$readMore_Name = 'Publication';
											?>
												<a href="<?php echo get_permalink($query2->post->ID); ?>" class="btn">Read <?php echo $readMore_Name;?></a>
											</footer>
										</section>
									</div>
									<?php if($i%2==0):?>
		    	...
		    	echo paginate_links( $args );echo '</div>'; ?>
		    	</div>
