...
/* Template Name: Ivy Oaks Camps Page Template */
                                            ...
                                            <ul class="posts-grid sm icons">
                                                ...
                                                <li>
                                                    <a href="https://interland3.donorperfect.net/weblink/weblink.aspx?name=timeforlyme&id=59">
                                                        ...
                                                        <span class="descript">
                                                            <strong class="title" title="Order Physical kit">Order Physical kit</strong>
                                                ...
                                                <li>
                                                    <a href="/education-awareness/curriculum-educational-activities/">
                                                        ...
                                                        <span class="descript">
                                                            <strong class="title" title="Educational Activities for Kids and Teens">Educational Activities for Kids and Teens</strong>
                                                            <!-- <em class="txt">Lorem ipsum dolor sit amet, consectetur sed.</em> -->                      <strong class="more">Learn more</strong>
                                                        </span>
                                                    </a>
                                                </li>
