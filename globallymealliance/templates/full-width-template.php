 ...
 <div class="container-section">
  ...
  <div class="main main1196">
				<?php if(!empty(get_the_content())){?>
				   <div class="content-left content-section-height" style="width: 100%;">
						<?php the_content();?>
						<div class="row">&nbsp;</div>
					</div>
				<?php }?>
							...
							echo '<div class="committee-members-data">
											...
											<a title="'.$row['title'].'" href="'.$row['link_url'].'" class="committee-members-name-img cf">
												...
												<div class="dis-table">
												 ...
												 <div class="committee-members-name"><div class="committee-members-name-inner">'.$row['title'].' <span>&gt;</span></div></div>
  ...
  <div class="aside-right content-section-height" style="display: none;">
