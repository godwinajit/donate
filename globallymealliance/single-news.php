...
<div class="blog inner-pages">
 ...
 <?php 
  ...
  if (has_post_thumbnail('thumbnail')) {
        ...
        echo '<div class="inner-banner" style="background-image:url('.$banneurl .')" >';
  }
  else {
    
    $banneurl = get_template_directory_uri().'/images/post-banner-bug.png';
        //echo '<div class="inner-banner" style="background-image:url('.$banneurl .')" data-media="(min-width: 768px)">';
  }
?>

<?php 
   //If has hero image display
   $hero_image = get_field('hero_image');

   if ($hero_image) {
      echo '<div class="inner-banner" style="background-image:url('.$hero_image .')" >';
   }
...
<div class="ipad-share">
  ...
  <div class="main main-img">
            <?php if ( has_post_thumbnail() && ! $hero_image && ! post_password_required() && ! is_attachment() ) : ?>

                <img src="<?php the_post_thumbnail_url("full"); ?>" class="img">

        <?php else : ?>

              <!--div class="inner-banner formobile" style="background-image:url('<?php //echo get_template_directory_uri(); ?>/images/post-default.jpg')"; --> 
 ...
 <div class="container-section blog-pages single">
  ...
  <div class="mobile-post-title-date  post-title-date">
    ...
    <?php if ( is_single() ) : ?>
      ...
      <?php $select_author = get_field('author');
          ...
          ?>   
          <span class="byauthor">By <?php the_title(); ?> </span>
      ...
      ?>
         <span class="source-field"> <?php echo $source ?></span>
      <?php else : ?>
          ...
          ?>   
                    ...
                    <div class="doctor-box">
                      <img src="<?php echo get_the_post_thumbnail_url() ?>" alt="">
                        <h3 class="doctor-title">About <?php the_title(); ?></h3>
                        <span class="doctor-title-sm"><?php echo $title; ?></span>
