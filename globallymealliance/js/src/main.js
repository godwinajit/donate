function initCustomForms() {
    jcf.setOptions("Select", {
        wrapNative: !1
    }), jcf.replaceAll('form.donate-form, form#tribe-bar-form .tribe-bar-filters, .resources-cat-container, .blog-categories-select, .published-research')
}
...
jQuery(function() {
    initSameHeight(), initToggleContent(), initCustomForms(), initRetinaCover(), initEnquire(), initLightbox(), initPopup("search-nav", ".search-opener"), initPopups();;
});
