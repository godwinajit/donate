...
$categoryIdsArr[] =  get_queried_object()->term_id;

$termchildren = get_term_children( get_queried_object()->term_id, 'support_group_states' );
foreach ($termchildren as $child) {
	$categoryIdsArr[] = $child;
}
...
$categoryArgs = array(
    ...
    'tax_query' => array(
        array(
            ...
            'field' => 'id',
            'terms' => $categoryIdsArr,
			'include_children' => true
        )
    ),
);
$services_post = new WP_Query( $categoryArgs );
