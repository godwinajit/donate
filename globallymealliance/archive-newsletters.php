...
<div class="inner-pages search-page search-results-view">
 ...
 <div class="container-section blog-pages search-results-view">
  ...
  <div class="page">
    ...
    ?>
     <!-- Title for Newsletters -->
     <h1 class="title-center">Newsletters</h1>
    <?php 
      }
    ?>  
            ...
            <ul id="ActiveYearMenu" class="search-year-menu">
              ...
              <li><a class="current_page_item" href="<?php echo get_post_type_archive_link('newsletters'); ?>">All</a></li>
                <?php //echo do_shortcode('[SidebarNewslettersYear]'); ?>
				  <?php wp_get_archives( array('post_type' => 'newsletters','post_status' => 'publish', 'type' => 'yearly','before' => '<ul>','after' => '</ul>', 'format' => 'html', 'show_post_count' => 0 ) ); ?>
                <li> <div class="select-mobile">
                  <select name="archive-dropdown" onchange="document.location.href=this.options[this.selectedIndex].value;">
                      <option value=""><?php echo esc_attr( __( 'Filter By Year' ) ); ?></option> 
                      <?php wp_get_archives( array('post_type' => 'newsletters', 'type' => 'yearly', 'format' => 'option', 'show_post_count' => 1 )); ?>
                 </select>  
            </div></li>     
            </ul>
          </div>
