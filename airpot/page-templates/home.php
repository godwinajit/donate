							...
							<div class="col-lg-offset-3 col-lg-9">
								<div class="block-holder">
									...
									<?php echo $header_text;?>
										<img src="<?php echo $small_image; ?>" width="418" height="392" alt="image description" class="img">
		...
		<section class="video-section text-middle">
			...
			<div class="text-block text-center">
				<div class="container">
					...
					<a href="<?php the_field('video__section_video_link')?>" class="link iframe" data-rel="iframe" width="900" height="500" rel=""><span class="fa icon-play"></span>WATCH THE VIDEO</a>
				</div>
			</div>
		</section>
