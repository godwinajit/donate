...
<table class="shop_table order_details">
	<thead>
		<tr>
			<th class="product-name" style="text-align:center;"><?php _e( 'Product', 'woocommerce' ); ?></th>
		</tr>
	</thead>
	<tbody>
		<?php
					...
					<tr class="<?php echo esc_attr( apply_filters( 'woocommerce_order_item_class', 'order_item', $item, $order ) ); ?>">
						<td class="product-name" style="text-align:center;>
							<?php
								...
								if(count($item['wdm_user_custom_data'])>0):
										$custom_data = maybe_unserialize($item['wdm_user_custom_data'] );
...
<?php
	if ( $order->billing_email ) {
		echo '<tr><th style="border-top: 1px solid black  !important;">' . __( 'Email:', 'woocommerce' ) . '</th><td style="border-top: 1px solid black  !important;" data-title="' . __( 'Email', 'woocommerce' ) . '">' . $order->billing_email . '</td></tr>';
	}
